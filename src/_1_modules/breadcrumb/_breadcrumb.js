...
const //hooks
	_module =  $('.JS-breadcrumb'),
	_target = $('.JS-breadcrumb__target'),
	_trigger = $('.JS-breadcrumb__trigger');

const //classes
	open_ = '-breadcrumb--open';
...
export default function() {
	console.log('The breadcrumb module javascript has loaded');
