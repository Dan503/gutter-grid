...
let bp = require(['..','..', dirs.source, dirs.scripts, '_config', 'bp_break-points.js'].join('/'));
...
export { gulp, plugins, args, config, validFileTypes, basePath, pjson, dirs, entries, taskTarget, browserSync, notification_icon_location, bp, jsWatch }
